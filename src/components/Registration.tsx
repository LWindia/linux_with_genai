...
const Registration = () => {
  ...
  // Target date: 20th September 2025 at 4 PM IST
  const targetDate = new Date('2025-09-20T16:00:00+05:30');
        ...
        <div className="text-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-8">
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2">
              ...
              <span className="text-white font-medium">20th September 2025</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2">
              <Clock className="w-4 h-4 text-[#ffd100]" />
              <span className="text-white font-medium">4:00 PM IST onwards</span>
            </div>
            <div className="flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2">
            ...
            <div className="bg-red-500/10 backdrop-blur-sm border border-red-500/20 rounded-2xl p-12 shadow-2xl">
              ...
              <div className="bg-white/5 rounded-xl p-4">
                <p className="text-gray-400">
                  Workshop Date: <span className="text-white font-semibold">20th September 2025</span><br />
                  Time: <span className="text-white font-semibold">4:00 PM IST onwards</span>
                </p>
              </div>
            </div>
          </div>
